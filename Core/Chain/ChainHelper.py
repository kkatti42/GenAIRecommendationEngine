...
# These methods are only used when running the application using CHAIN

def get_weather_data(zip_code: str) -> Union[Dict[str, Any], str]:
    """
...
def get_itemization_data(start: str, end: str) -> Union[Dict[str, Any], str]:
    """
    ...
    url = (
        ...
        "showPercentage=true&round=true"
    )
    ...
    try:
        ...
        return f"HTTP error fetching itemization data: {http_err}"
    except Exception as e:
        return f"Error fetching itemization data: {e}"